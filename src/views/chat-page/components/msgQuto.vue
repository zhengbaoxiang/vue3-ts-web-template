<template>
    <div class="qutoCon">
        ...
        <div class="msgContain">
            ...
            <div class="msgContent cardCon" v-if="qutoObj.citationContentType === 111">
                <p :title="qutoObj.citationFileName">
                    [文章] {{ qutoObj.citationContent }}
                </p>
            </div>
            <div class="msgContent richCon" v-if="qutoObj.citationContentType === 110">
                <p :title="qutoObj.citationFileName">
                    {{ qutoObj.citationContent }}
                </p>
            </div>
        </div>
    </div>
